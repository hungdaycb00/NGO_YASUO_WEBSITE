            ...
            <div class="table-responsive">
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::to('edit_profile/'.$cate_member->member_id)}}" class="active styling-edit" ui-toggle-class="">
                                <i class="fa fa-pencil-square-o text-success text-active"></i>
                            </a>
                            <a onclick="return confirm('Are you sure to delete ?')" href="{{URL::to('delete_profile/'.$cate_member->member_id)}}" class="active  styling-edit" ui-toggle-class="">
