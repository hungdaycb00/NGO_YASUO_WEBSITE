...
@section('user_content')
    <div class="container-fluid"><p class="h1 mt-15">Donate</p></div>
                            ...
                            <div class="w3_agileits_qualifications">
                                ...
                                <div class="card-bounding agileits">
                                    ...
                                    <div class="card-details">
                                        ...
                                        <input type="text" name="card number" class="hm" placeholder="0000 0000 0000 0000"
                                               maxlength="19" onkeyup="$cc.validate(event)" required="">
                                    ...
                                    <div class="card-details agileits-w3layouts">
                                        <div class="expiration">
                                            ...
                                            <input type="text" name="date" onkeyup="$cc.expiry.call(this,event)" maxlength="7"
