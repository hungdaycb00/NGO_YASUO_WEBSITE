...
<html class="supernova"><head>
    ...
    <link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F202160152327442" title="oEmbed Form">
    <link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F202160152327442" title="oEmbed Form">
    <meta property="og:title" content="Helping hands orphanage Donation Form" >
    <meta property="og:url" content="https://form.jotform.com/202160152327442" >
    ...
    <style type="text/css" id="form-designer-style">
        ...
        .form-all:before {
            content: "";
            background-image: url("https://www.jotform.com/uploads/guest_cb42678ffcc8e877/form_files/Logo.5f28e14fe4b241.24425685.png");
    ...
    <script type="text/javascript">
        ...
        JotForm.prepareCalculationsOnTheFly([null,{"name":"clickTo","qid":"1","text":"Helping hands orphanage Donation Form","type":"control_head"},{"name":"submit","qid":"2","text":"Submit","type":"control_button"},{"name":"donationRange","qid":"3","text":"Donation Range","type":"control_paypalpro"},{"name":"donorsName","qid":"4","text":"Donors Name","type":"control_fullname"},{"name":"donorsEmail","qid":"5","text":"Donors E-mail","type":"control_email"},{"name":"donorsAddress6","qid":"6","text":"Donors Address","type":"control_address"}]);
        setTimeout(function() {
            JotForm.paymentExtrasOnTheFly([null,{"name":"clickTo","qid":"1","text":"Helping hands orphanage Donation Form","type":"control_head"},{"name":"submit","qid":"2","text":"Submit","type":"control_button"},{"name":"donationRange","qid":"3","text":"Donation Range","type":"control_paypalpro"},{"name":"donorsName","qid":"4","text":"Donors Name","type":"control_fullname"},{"name":"donorsEmail","qid":"5","text":"Donors E-mail","type":"control_email"},{"name":"donorsAddress6","qid":"6","text":"Donors Address","type":"control_address"}]);}, 20);
    </script>
</head>
<body>
<form class="jotform-form" action="https://pci.jotform.com/submit/202160152327442" method="post" name="form_202160152327442" id="202160152327442" accept-charset="utf-8" autocomplete="on">
    <input type="hidden" name="formID" value="202160152327442" />
        ...
        <ul class="form-section page-section">
            ...
            *
                ...
                <div id="cid_3" class="form-input-wide jf-required">
                    <div data-wrapper-react="true" id="payment-wrapper-songbird" data-currency="USD" data-paymentType="donation" data-sandbox="Disabled">
                ...
                <input type="text" class="form-textbox validate[required, Numeric]" id="input_3_donation" name="q3_donationRange[price]" value="" data-component="paymentDonation" />
                USD
                <label class="form-sub-label" for="input_3_donation" style="min-height:13px" aria-hidden="false"> Donation </label>
              </span>
                            <hr/>
                        </div>
                        <table class="form-address-table payment-form-table" style="border:0" cellPadding="4" cellSpacing="0">
                            ...
                            <tr>
                                <td valign="top" style="min-width:50px;vertical-align:top" rowspan="2">
                                    <input type="radio" class="paymentTypeRadios" id="input_3_paymentType_credit" name="q3_donationRange[paymentType]" value="credit" />
                                ...
                                <td align="left" valign="top" style="padding-bottom:2px !important;text-align:left;vertical-align:top">
                                    <input type="radio" class="paymentTypeRadios" id="input_3_paymentType_express" name="q3_donationRange[paymentType]" checked="" value="express" />
                        ...
                        <table style="display:none;border:0" id="creditCardTable" class="form-address-table payment-form-table" cellPadding="0" cellSpacing="0">
                            ...
                            <tr>
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_cc_firstName" name="q3_donationRange[cc_firstName]" class="form-textbox validate[required] cc_firstName" size="20" value="" data-component="cc_firstName" />
                      <label class="form-sub-label" for="input_3_cc_firstName" id="sublabel_cc_firstName" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> First Name </label>
                                ...
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_cc_lastName" name="q3_donationRange[cc_lastName]" class="form-textbox validate[required] cc_lastName" size="20" value="" data-component="cc_lastName" />
                      <label class="form-sub-label" for="input_3_cc_lastName" id="sublabel_cc_lastName" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> Last Name </label>
                            ...
                            <tr>
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="number" id="input_3_cc_number" name="q3_donationRange[cc_number]" class="form-textbox validate[required] cc_number" autoComplete="off" size="20" value="" data-component="cc_number" />
                      <label class="form-sub-label" for="input_3_cc_number" id="sublabel_cc_number" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> Credit Card Number </label>
                                ...
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="number" id="input_3_cc_ccv" name="q3_donationRange[cc_ccv]" class="form-textbox validate[required] cc_ccv" autoComplete="off" style="width:52px" value="" data-component="cc_ccv" />
                      <label class="form-sub-label" for="input_3_cc_ccv" id="sublabel_cc_ccv" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> Security Code </label>
                            ...
                            <tr>
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <select class="form-dropdown validate[required] cc_exp_month" name="q3_donationRange[cc_exp_month]" id="input_3_cc_exp_month" data-component="cc_exp_month">
                        <option>  </option>
                      ...
                      <label class="form-sub-label" for="input_3_cc_exp_month" id="sublabel_cc_exp_month" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> Expiration Month </label>
                                ...
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <select class="form-dropdown validate[required] cc_exp_year" name="q3_donationRange[cc_exp_year]" id="input_3_cc_exp_year" data-component="cc_exp_year">
                        <option>  </option>
                      ...
                      <label class="form-sub-label" for="input_3_cc_exp_year" id="sublabel_cc_exp_year" style="min-height:13px;margin:0 0 3px 0" aria-hidden="false"> Expiration Year </label>
                            ...
                            <tr>
                                <td colSpan="2">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_addr_line1" name="q3_donationRange[addr_line1]" class="form-textbox validate[required] form-address-line" value="" data-component="addr_line1" />
                      <label class="form-sub-label" for="input_3_addr_line1" id="sublabel_3_addr_line1" style="min-height:13px" aria-hidden="false"> Street Address </label>
                            ...
                            <tr>
                                <td colSpan="2">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_addr_line2" name="q3_donationRange[addr_line2]" class="form-textbox form-address-line" size="46" value="" data-component="addr_line2" />
                      <label class="form-sub-label" for="input_3_addr_line2" id="sublabel_3_addr_line2" style="min-height:13px" aria-hidden="false"> Street Address Line 2 </label>
                            ...
                            <tr>
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_city" name="q3_donationRange[city]" class="form-textbox validate[required] form-address-city" size="21" value="" data-component="city" />
                      <label class="form-sub-label" for="input_3_city" id="sublabel_3_city" style="min-height:13px" aria-hidden="false"> City </label>
                    </span>
                                </td>
                                <td>
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_state" name="q3_donationRange[state]" class="form-textbox validate[required] form-address-state" size="22" value="" data-component="state" />
                      <label class="form-sub-label" for="input_3_state" id="sublabel_3_state" style="min-height:13px" aria-hidden="false"> State / Province </label>
                            ...
                            <tr>
                                <td width="50%">
                    <span class="form-sub-label-container " style="vertical-align:top">
                      <input type="text" id="input_3_postal" name="q3_donationRange[postal]" class="form-textbox validate[required] form-address-postal" size="10" value="" data-component="postal" />
            ...
            <span class="form-sub-label-container " style="vertical-align:top" data-input-type="first">
              ...
              <input type="text" id="last_4" name="q4_donorsName[last]" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_4 sublabel_4_last" />
            ...
            <li class="form-line" data-type="control_address" id="id_6">
              ...
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container " style="vertical-align:top">
                  <input type="text" id="input_6_addr_line1" name="q6_donorsAddress6[addr_line1]" class="form-textbox form-address-line" value="" data-component="address_line_1" aria-labelledby="label_6 sublabel_6_addr_line1" />
              ...
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container " style="vertical-align:top">
                  <input type="text" id="input_6_addr_line2" name="q6_donorsAddress6[addr_line2]" class="form-textbox form-address-line" value="" data-component="address_line_2" aria-labelledby="label_6 sublabel_6_addr_line2" />
    ...
    <input type="hidden" id="simple_spc" name="simple_spc" value="202160152327442" />
    <script type="text/javascript">
        document.getElementById("si" + "mple" + "_spc").value = "202160152327442-202160152327442";
    </script>
